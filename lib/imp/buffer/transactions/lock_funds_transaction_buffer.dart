...
class LockFundsTransactionBuffer {
  ...
  static const fb.Reader<LockFundsTransactionBuffer> reader = const _LockFundsTransactionBufferReader();
  ...
  List<int> get hash => const fb.ListReader<int>(const fb.Uint8Reader()).vTableGet(_bc, _bcOffset, 24, null);
...
class _LockFundsTransactionBufferReader extends fb.TableReader<LockFundsTransactionBuffer> {
  ...
  LockFundsTransactionBuffer createObject(fb.BufferContext bc, int offset) => 
    new LockFundsTransactionBuffer._(bc, offset);
}
