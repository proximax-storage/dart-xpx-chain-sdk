...
class SecretLockTransactionBuffer {
  ...
  List<int>? get secret => const fb.Uint8ListReader().vTableGetNullable(_bc, _bcOffset, 26);

  List<int>? get recipient => const fb.Uint8ListReader().vTableGetNullable(_bc, _bcOffset, 28);
