...
class BlockchainUpgradeTransactionBuffer {
  BlockchainUpgradeTransactionBuffer._(this._bc, this._bcOffset);

  factory BlockchainUpgradeTransactionBuffer(List<int> bytes) {
  ...
  @override
  String toString() {
    return 'BlockchainUpgradeTransactionBuffer{size: ${size}, signature: ${signature}, signer: ${signer}, version: ${version}, type: ${type}, maxFee: ${maxFee}, deadline: ${deadline}, upgradePeriod: ${upgradePeriod}, newBlockChainVersion: ${newBlockChainVersion}}';
  }
}
...
class BlockchainUpgradeTransactionBufferBuilder {
  BlockchainUpgradeTransactionBufferBuilder(this.fbBuilder);
  ...
  int addUpgradePeriodOffset(int? offset) {
    fbBuilder.addOffset(7, offset);
    return fbBuilder.offset;
  }

  int addNewBlockChainVersionOffset(int? offset) {
...
class BlockchainUpgradeTransactionBufferObjectBuilder extends fb.ObjectBuilder {
  final int? _size;
  ...
  final List<int>? _upgradePeriod;
  final List<int>? _newBlockChainVersion;

  BlockchainUpgradeTransactionBufferObjectBuilder({
    int? size,
    List<int>? signature,
    List<int>? signer,
    int? version,
    ...
    List<int>? maxFee,
    List<int>? deadline,
    List<int>? upgradePeriod,
    List<int>? newBlockChainVersion,
  })  : _size = size,
        ...
        _maxFee = maxFee,
        _deadline = deadline,
        _upgradePeriod = upgradePeriod,
        _newBlockChainVersion = newBlockChainVersion;
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(7, upgradePeriodOffset);
    fbBuilder.addOffset(8, newBlockChainVersionOffset);
    return fbBuilder.endTable();
  }
