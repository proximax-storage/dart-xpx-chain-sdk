...
class MosaicDefinitionTransactionBuffer {
  ...
  int get indicateDuration => const fb.Uint8Reader().vTableGet(_bc, _bcOffset, 28, 0);
  List<int> get duration => const fb.ListReader<int>(const fb.Uint32Reader()).vTableGet(_bc, _bcOffset, 30, null);
