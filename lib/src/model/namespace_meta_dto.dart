...
class NamespaceMetaDTO {
  ...
  static List<NamespaceMetaDTO> listFromJson(List<dynamic> json) {
    return json == null ? new List<NamespaceMetaDTO>() : json.map((value) => new NamespaceMetaDTO.fromJson(value)).toList();
  }
  ...
  static Map<String, NamespaceMetaDTO> mapFromJson(Map<String, Map<String, dynamic>> json) {
    ...
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new NamespaceMetaDTO.fromJson(value));
    }
    return map;
  }
}
