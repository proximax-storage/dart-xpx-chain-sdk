...
const int defaultMosaicLevyOnePercentValue = 100000; // default amount that represent 1% of native currency
...
class MosaicLevy {
  ...
  static MosaicLevy createWithPercentageFee(
          Address recipient, MosaicId mosaicId, int percentage, int? mosaicOnePercentValue) =>
      MosaicLevy(MosaicLevyType.levyPercentileFee, recipient, mosaicId,
          MosaicLevy.createLevyFeePercentile(percentage, mosaicOnePercentValue));

  static MosaicLevy createWithAbsoluteFee(Address recipient, MosaicId mosaicId, int amount) =>
      MosaicLevy(MosaicLevyType.levyAbsoluteFee, recipient, mosaicId, Uint64.fromInt(amount));

  static Uint64 createLevyFeePercentile(int percentage, num? mosaicOnePercentValue) {
  ...
  Map<String, dynamic> toJson() {
    final val = <String, dynamic>{'type': type, 'recipient': recipient, 'mosaicId': mosaicId, 'fee': fee};
    return val;
  }
}
