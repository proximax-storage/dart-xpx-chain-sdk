...
class NamespaceInfoDTO {
  ...
  NamespaceInfoDTO.fromJson(Map<String, dynamic> json) {
    ...
    meta =
      ...
      new NamespaceMetaDTO.fromJson(json['meta'])
;
    namespace =
      
      
      new NamespaceDTO.fromJson(json['namespace'])
;
  }
  ...
  static List<NamespaceInfoDTO> listFromJson(List<dynamic> json) {
    return json == null ? new List<NamespaceInfoDTO>() : json.map((value) => new NamespaceInfoDTO.fromJson(value)).toList();
  }
  ...
  static Map<String, NamespaceInfoDTO> mapFromJson(Map<String, Map<String, dynamic>> json) {
    ...
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new NamespaceInfoDTO.fromJson(value));
    }
    return map;
  }
}
