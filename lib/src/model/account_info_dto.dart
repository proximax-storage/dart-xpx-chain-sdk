...
class AccountInfoDTO {
  ...
  AccountInfoDTO.fromJson(Map<String, dynamic> json) {
    ...
    meta =
      ...
      new AccountMetaDTO.fromJson(json['meta'])
;
    account =
      
      
      new AccountDTO.fromJson(json['account'])
;
  }
  ...
  static List<AccountInfoDTO> listFromJson(List<dynamic> json) {
    return json == null ? new List<AccountInfoDTO>() : json.map((value) => new AccountInfoDTO.fromJson(value)).toList();
  }
  ...
  static Map<String, AccountInfoDTO> mapFromJson(Map<String, Map<String, dynamic>> json) {
    ...
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AccountInfoDTO.fromJson(value));
    }
    return map;
  }
}
