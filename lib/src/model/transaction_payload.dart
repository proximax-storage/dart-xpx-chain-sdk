...
class TransactionPayload {
  ...
  static List<TransactionPayload> listFromJson(List<dynamic> json) {
    return json == null ? new List<TransactionPayload>() : json.map((value) => new TransactionPayload.fromJson(value)).toList();
  }
  ...
  static Map<String, TransactionPayload> mapFromJson(Map<String, Map<String, dynamic>> json) {
    ...
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new TransactionPayload.fromJson(value));
    }
    return map;
  }
}
