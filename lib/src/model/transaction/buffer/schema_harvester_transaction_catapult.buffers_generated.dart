...
class HarvesterTransactionBuffer {
  HarvesterTransactionBuffer._(this._bc, this._bcOffset);

  factory HarvesterTransactionBuffer(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<HarvesterTransactionBuffer> reader = _HarvesterTransactionBufferReader();
  ...
  @override
  String toString() {
    return 'HarvesterTransactionBuffer{size: ${size}, signature: ${signature}, signer: ${signer}, version: ${version}, type: ${type}, maxFee: ${maxFee}, deadline: ${deadline}}';
  }
}

class _HarvesterTransactionBufferReader extends fb.TableReader<HarvesterTransactionBuffer> {
  const _HarvesterTransactionBufferReader();

  @override
  HarvesterTransactionBuffer createObject(fb.BufferContext bc, int offset) => HarvesterTransactionBuffer._(bc, offset);
}

class HarvesterTransactionBufferBuilder {
  HarvesterTransactionBufferBuilder(this.fbBuilder);
...
class HarvesterTransactionBufferObjectBuilder extends fb.ObjectBuilder {
  final int? _size;
  ...
  HarvesterTransactionBufferObjectBuilder({
    int? size,
    List<int>? signature,
    List<int>? signer,
    int? version,
