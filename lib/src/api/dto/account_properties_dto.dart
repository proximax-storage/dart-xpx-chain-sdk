...
class AccountPropertiesDTO {
  AccountPropertiesDTO.fromJson(json) : assert(json.isNotEmpty, 'json must not be empty') {
...
class AccountPropertiesInfoDTO {
  AccountPropertiesInfoDTO.fromJson(json) : assert(json.isNotEmpty, 'json must not be empty') {
...
class AccountPropertiesMetaDTO {
  AccountPropertiesMetaDTO.fromJson(json) : assert(json.isNotEmpty, 'json must not be empty') {
    _id = json['id'];
  }
