...
class MetadataModificationBufferObjectBuilder extends fb.ObjectBuilder {
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? keyOffset =
        _key == null ? null : fbBuilder.writeListUint8(_key!);
...
class ModifyMetadataTransactionBufferObjectBuilder extends fb.ObjectBuilder {
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? metadataIdOffset =
        _metadataId == null ? null : fbBuilder.writeListUint8(_metadataId!);
