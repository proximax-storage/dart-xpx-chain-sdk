...
;
    supply =
      ...
      new UInt64DTO.fromJson(json['supply'])
;
    height =
...
;
    ...
    properties =
      ...
      new MosaicPropertiesDTO.fromJson(json['properties'])
;
    levy =
...
;
  ...
  static List<MosaicDefinitionDTO> listFromJson(List<dynamic> json) {
    return json == null ? new List<MosaicDefinitionDTO>() : json.map((value) => new MosaicDefinitionDTO.fromJson(value)).toList();
  }
  ...
  static Map<String, MosaicDefinitionDTO> mapFromJson(Map<String, Map<String, dynamic>> json) {
    ...
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new MosaicDefinitionDTO.fromJson(value));
    }
    return map;
  }
}
