...
;
    namespaceId =
      ...
      new UInt64DTO.fromJson(json['namespaceId'])
;
    name =
        json['name']
    ;
  ...
  static List<NamespaceNameDTO> listFromJson(List<dynamic> json) {
    return json == null ? new List<NamespaceNameDTO>() : json.map((value) => new NamespaceNameDTO.fromJson(value)).toList();
  }
  ...
  static Map<String, NamespaceNameDTO> mapFromJson(Map<String, Map<String, dynamic>> json) {
    ...
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new NamespaceNameDTO.fromJson(value));
    }
    return map;
  }
}
