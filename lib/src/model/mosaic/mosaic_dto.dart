...
class MosaicDTO {
  ...
  static List<MosaicDTO> listFromJson(List<dynamic> json) => json == null
      ? null
      : json.map((value) => MosaicDTO.fromJson(value)).toList();
}
...
class MosaicDefinitionTransactionInfoDTO {
  ...
  MosaicDefinitionTransactionDTO _transaction;
