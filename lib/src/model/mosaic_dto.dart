...
class MosaicDTO {
  ...
  MosaicDTO.fromJson(Map<String, dynamic> json) {
    ...
    id =
      ...
      new UInt64DTO.fromJson(json['id'])
;
    amount =
      
      
      new UInt64DTO.fromJson(json['amount'])
;
  }
  ...
  static List<MosaicDTO> listFromJson(List<dynamic> json) {
    return json == null ? new List<MosaicDTO>() : json.map((value) => new MosaicDTO.fromJson(value)).toList();
  }

  static Map<String, MosaicDTO> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, MosaicDTO>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new MosaicDTO.fromJson(value));
    }
    return map;
  }
}
