...
class NamespaceDTO {
  ...
  NamespaceDTO.fromJson(Map<String, dynamic> json) {
    ...
    startHeight =
      ...
      new UInt64DTO.fromJson(json['startHeight'])
;
    endHeight =
      
      
      new UInt64DTO.fromJson(json['endHeight'])
;
    depth =
        json['depth']
    ;
    level0 =
      ...
      new UInt64DTO.fromJson(json['level0'])
;
    level1 =
      
      
      new UInt64DTO.fromJson(json['level1'])
;
    level2 =
      
      
      new UInt64DTO.fromJson(json['level2'])
;
    type =
        json['type']
    ;
    alias =
      ...
      new AliasDTO.fromJson(json['alias'])
;
    parentId =
...
;
  ...
  static List<NamespaceDTO> listFromJson(List<dynamic> json) {
    return json == null ? new List<NamespaceDTO>() : json.map((value) => new NamespaceDTO.fromJson(value)).toList();
  }

  static Map<String, NamespaceDTO> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, NamespaceDTO>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new NamespaceDTO.fromJson(value));
    }
    return map;
  }
}
