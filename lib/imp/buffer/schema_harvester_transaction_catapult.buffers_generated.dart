...
class HarvesterTransactionBuffer {
  ...
  static const fb.Reader<HarvesterTransactionBuffer> reader =
      _HarvesterTransactionBufferReader();
...
class _HarvesterTransactionBufferReader
    extends fb.TableReader<HarvesterTransactionBuffer> {
  const _HarvesterTransactionBufferReader();

  @override
  HarvesterTransactionBuffer createObject(fb.BufferContext bc, int offset) =>
      HarvesterTransactionBuffer._(bc, offset);
}
