...
class EncryptedMessage extends Message {
  ...
  static EncryptedMessage create(
      final String plainTextMessage, final String senderPrivateKey, final String recipientPublicKey) {
    ArgumentError.checkNotNull(plainTextMessage);

    // Encrypts the message
    final String encryptedPayload = crypto.encryptMessage(plainTextMessage, senderPrivateKey, recipientPublicKey);
  ...
  static PlainMessage decrypt(
      final EncryptedMessage encryptedMessage, final String recipientPrivateKey, final String senderPublicKey) {
    ArgumentError.checkNotNull(encryptedMessage);
    ArgumentError.checkNotNull(encryptedMessage.payload);

    final String decrypted =
        crypto.decryptMessage(ByteUtils.bytesToHex(encryptedMessage.payload), recipientPrivateKey, senderPublicKey);
