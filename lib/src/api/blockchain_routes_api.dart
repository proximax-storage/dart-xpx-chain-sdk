...
class BlockchainRoutesApi {
  ...
  BlockchainRoutesApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<BlockInfoDTO> getBlockByHeight(int height) async {
    ...
    String path = "/block/{height}".replaceAll("{format}","json").replaceAll("{" + "height" + "}", height.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'BlockInfoDTO') as BlockInfoDTO ;
    } else {
      return null;
    }
  }
  ...
  Future<List<Object>> getBlockReceipts(int height) async {
    ...
    // create path and map variables
    String path = "/block/{height}/receipts".replaceAll("{format}","json").replaceAll("{" + "height" + "}", height.toString());
  ...
  Future<List<Object>> getBlockTransactions(int height, { int pageSize, String id }) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/block/{height}/transactions".replaceAll("{format}","json").replaceAll("{" + "height" + "}", height.toString());
  ...
  Future<HeightDTO> getBlockchainHeight() async {
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'HeightDTO') as HeightDTO ;
    } else {
      return null;
    }
  }
  ...
  Future<BlockchainScoreDTO> getBlockchainScore() async {
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'BlockchainScoreDTO') as BlockchainScoreDTO ;
    } else {
      return null;
    }
  }
  ...
  Future<List<BlockInfoDTO>> getBlocksByHeightWithLimit(int height, int limit) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/blocks/{height}/limit/{limit}".replaceAll("{format}","json").replaceAll("{" + "height" + "}", height.toString()).replaceAll("{" + "limit" + "}", limit.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return 
        (apiClient.deserialize(response.body, 'List<BlockInfoDTO>') as List).map((item) => item as BlockInfoDTO).toList();
    } else {
      return null;
    }
  }
  ...
  Future<BlockchainStorageInfoDTO> getDiagnosticStorage() async {
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'BlockchainStorageInfoDTO') as BlockchainStorageInfoDTO ;
    } else {
      return null;
    }
  }
  ...
  Future<MerkleProofInfoDTO> getMerkleReceipts(int height, String hash) async {
    ...
    // create path and map variables
    String path = "/block/{height}/receipt/{hash}/merkle".replaceAll("{format}","json").replaceAll("{" + "height" + "}", height.toString()).replaceAll("{" + "hash" + "}", hash.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'MerkleProofInfoDTO') as MerkleProofInfoDTO ;
    } else {
      return null;
    }
  }
  ...
  Future<MerkleProofInfoDTO> getMerkleTransaction(int height, String hash) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/block/{height}/transaction/{hash}/merkle".replaceAll("{format}","json").replaceAll("{" + "height" + "}", height.toString()).replaceAll("{" + "hash" + "}", hash.toString());
