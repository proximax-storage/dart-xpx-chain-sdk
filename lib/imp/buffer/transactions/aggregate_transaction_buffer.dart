...
class AggregateTransactionBuffer {
  ...
  static const fb.Reader<AggregateTransactionBuffer> reader = const _AggregateTransactionBufferReader();
  ...
  List<int> get transactions => const fb.ListReader<int>(const fb.Uint8Reader()).vTableGet(_bc, _bcOffset, 20, null);
