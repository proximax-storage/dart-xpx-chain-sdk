...
class TransactionRoutesApi {
  ...
  Future<Object> announceCosignatureTransaction(TransactionPayload payload) async {
  ...
  Future<Object> getTransaction(String transactionId) async {
    ...
    // create path and map variables
    String path = "/transaction/{transactionId}".replaceAll("{format}","json").replaceAll("{" + "transactionId" + "}", transactionId.toString());
  ...
  Future<TransactionStatusDTO> getTransactionStatus(String hash) async {
    ...
    // create path and map variables
    String path = "/transaction/{hash}/status".replaceAll("{format}","json").replaceAll("{" + "hash" + "}", hash.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'TransactionStatusDTO') as TransactionStatusDTO ;
    } else {
      return null;
    }
  }
  ...
  Future<List<TransactionStatusDTO>> getTransactionsStatuses(TransactionHashes transactionHashes) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return 
        (apiClient.deserialize(response.body, 'List<TransactionStatusDTO>') as List).map((item) => item as TransactionStatusDTO).toList();
    } else {
      return null;
    }
  }
