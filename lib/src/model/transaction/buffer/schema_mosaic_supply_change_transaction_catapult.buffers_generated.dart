...
class MosaicSupplyChangeTransactionBuffer {
  ...
  List<int>? get delta => const fb.ListReader<int>(fb.Uint32Reader()).vTableGetNullable(_bc, _bcOffset, 22);
...
class MosaicSupplyChangeTransactionBufferObjectBuilder extends fb.ObjectBuilder {
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? deltaOffset = _delta == null ? null : fbBuilder.writeListUint32(_delta!);
    fbBuilder.startTable(10);
