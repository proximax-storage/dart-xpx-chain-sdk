...
class MerkleProofInfoDTO {
  ...
  MerkleProofInfoDTO.fromJson(Map<String, dynamic> json) {
    ...
    payload =
      ...
      new MerkleProofInfoPayload.fromJson(json['payload'])
;
    type =
        json['type']
    ;
  ...
  static List<MerkleProofInfoDTO> listFromJson(List<dynamic> json) {
    return json == null ? new List<MerkleProofInfoDTO>() : json.map((value) => new MerkleProofInfoDTO.fromJson(value)).toList();
  }
  ...
  static Map<String, MerkleProofInfoDTO> mapFromJson(Map<String, Map<String, dynamic>> json) {
    ...
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new MerkleProofInfoDTO.fromJson(value));
    }
    return map;
  }
}
