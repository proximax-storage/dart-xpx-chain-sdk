...
class MosaicAliasDefinitionTransactionBuffer {
  ...
  static const fb.Reader<MosaicAliasDefinitionTransactionBuffer> reader = const _MosaicAliasDefinitionTransactionBufferReader();
  ...
  List<int> get namespaceId => const fb.ListReader<int>(const fb.Uint32Reader()).vTableGet(_bc, _bcOffset, 18, null);
...
class _MosaicAliasDefinitionTransactionBufferReader extends fb.TableReader<MosaicAliasDefinitionTransactionBuffer> {
  ...
  MosaicAliasDefinitionTransactionBuffer createObject(fb.BufferContext bc, int offset) => 
    new MosaicAliasDefinitionTransactionBuffer._(bc, offset);
}
